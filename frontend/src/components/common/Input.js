...
export const Input = ({
  ...
  const baseClasses = 'w-full rounded-xl focus:ring-2 focus:ring-offset-2 transition-all duration-300 py-3 pl-10 pr-3';
  const themeClasses = theme === 'light'
    ? 'bg-white border border-gray-300 dark:bg-gray-800 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-500 focus:border-purple-500 focus:ring-purple-500'
