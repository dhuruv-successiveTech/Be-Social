  ...
  if (error)
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex flex-col items-center">
        <Navbar />
        <div className="flex justify-center items-center h-[calc(100vh-64px)]">
          <p className="text-red-500 bg-red-50 dark:bg-red-900/30 rounded-xl p-4 shadow">
            Error loading post
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-3xl mx-auto px-4 py-8">
          <PageBackground>
            <Card className="p-8 animate-fadeIn" animate hover>
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  <p
                    ...
                    className="font-semibold text-indigo-600 dark:text-indigo-300 text-lg"
                  >
              ...
              <p className="text-gray-900 dark:text-white mb-6 text-lg font-medium">
                {post.caption}
              </p>
              ...
              <div className="border-t border-indigo-100 dark:border-indigo-900 pt-6">
                <h3 className="font-semibold text-indigo-600 dark:text-indigo-300 mb-4 text-lg">
                  Comments
                </h3>
